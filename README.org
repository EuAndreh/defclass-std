* defclass-std
  [[https://travis-ci.org/EuAndreh/defclass-std.svg?branch=master][https://travis-ci.org/EuAndreh/defclass-std.svg?branch=master]]

  [[https://travis-ci.org/EuAndreh/defclass-std.svg?branch=master]]
